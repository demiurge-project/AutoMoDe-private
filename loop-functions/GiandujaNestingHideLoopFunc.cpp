...
GiandujaNestingHideLoopFunction::GiandujaNestingHideLoopFunction() {
  ...
  m_CCoordRect2Pos = CVector2(-0.8,0);
...
void GiandujaNestingHideLoopFunction::Init(TConfigurationNode& t_tree) {
    ...
    m_cCoordRectSpot = CVector2(-0.7+a*1.4,0.6+b*0.4);
...
REGISTER_LOOP_FUNCTIONS(GiandujaNestingHideLoopFunction, "gianduja_nesting_loop_functions");
