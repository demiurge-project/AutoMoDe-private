...
#include "MateSPCLoopFunc.h"

/****************************************/
/****************************************/

MateSPCLoopFunction::MateSPCLoopFunction() {
  m_fSideSquare = 0.6;
  m_fRadiusCircle = 0.3;
  m_fRadiusRobot = 0.04;
...
MateSPCLoopFunction::MateSPCLoopFunction(const MateSPCLoopFunction& orig) {}
...
void MateSPCLoopFunction::Destroy() {}

/****************************************/
/****************************************/

void MateSPCLoopFunction::Reset() {
...
argos::CColor MateSPCLoopFunction::GetFloorColor(const argos::CVector2& c_position_on_plane) {
...
void MateSPCLoopFunction::PostExperiment() {
...
Real MateSPCLoopFunction::GetObjectiveFunction() {
...
Real MateSPCLoopFunction::ComputeObjectiveFunction() {
...
CVector2 MateSPCLoopFunction::RandomPointOnSquareArea(){
...
CVector2 MateSPCLoopFunction::RandomPointOnCirclePerimeter(){
...
bool MateSPCLoopFunction::IsOnSquareArea(CVector2 c_point){
...
bool MateSPCLoopFunction::IsOnCirclePerimeter(CVector2 c_point) {
...
CVector3 MateSPCLoopFunction::GetRandomPosition() {
  Real temp;
...
REGISTER_LOOP_FUNCTIONS(MateSPCLoopFunction, "mate_spc_loop_functions");
