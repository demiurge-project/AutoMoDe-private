...
#ifndef AUTOMODE_LOOP_FUNCTIONS_PSEUDO_REALITY
#define AUTOMODE_LOOP_FUNCTIONS_PSEUDO_REALITY
...
class AutoMoDeLoopFunctionsPseudoReality: public CLoopFunctions {
  protected:

    ~AutoMoDeLoopFunctionsPseudoReality();
